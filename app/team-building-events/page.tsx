  ...
  return (
    <main className="section">
      <div className="container">
        <h1 className="page-h1">Team Building Events That People Actually Enjoy &mdash; Rock &amp; Pour</h1>
        <p style={{ fontSize: '1.2rem', maxWidth: '800px', margin: '0 auto 2rem' }}>
          Escape rooms. Trust falls. Awkward icebreaker games. Most team building events make people dread the invite email. Rock &amp; Pour is the opposite &mdash; a live music and unlimited drinks experience that your team will genuinely look forward to, talk about for months, and actually ask to do again.
        </p>
        ...
        <section className="scroll-reveal" style={{ marginBottom: '3rem' }}>
          <h2>Rock &amp; Pour vs Other Team Building Options</h2>

          <h3>vs Escape Rooms</h3>
          <p>
            Escape rooms last 60 minutes, cost &pound;25&ndash;&pound;40 per person, and then you need to find somewhere to go afterwards. Rock &amp; Pour is an entire evening of entertainment and drinks for &pound;55. And nobody has to pretend to enjoy solving puzzles under pressure.
          </p>

          <h3>vs Restaurant Bookings</h3>
          <p>
            Team dinners are passive. People sit in the same seats all evening and talk to the same two colleagues. At Rock &amp; Pour, everyone moves around, mingles, and connects over shared music. The energy creates conversation in ways that a restaurant table never can.
          </p>

          <h3>vs Go-Karting / Activity Days</h3>
          <p>
        ...
        <section className="scroll-reveal" style={{ marginBottom: '3rem' }}>
          <h2>Perfect for Every Type of Team Event</h2>
          <p>
            Rock &amp; Pour works for a wide range of <a href="/corporate-events" className="gold-link">corporate occasions</a>:
          </p>
          <ul style={{ lineHeight: '2', paddingLeft: '1.5rem' }}>
            <li><strong>End-of-year celebrations:</strong> Reward your team with the night they actually want</li>
            <li><strong>Christmas parties:</strong> Skip the awkward sit-down dinner for a proper party</li>
            <li><strong>New starter welcome events:</strong> Nothing integrates people faster than shared fun</li>
            <li><strong>Department socials:</strong> Break down silos over <a href="/indie-rock-night" className="gold-link">indie rock</a> and unlimited drinks</li>
        ...
        <section className="scroll-reveal" style={{ marginBottom: '3rem' }}>
          ...
          <p>
            If you&rsquo;re the person tasked with organising the team event, Rock &amp; Pour makes your life easy. Check <a href="/" className="gold-link">upcoming dates</a>, book tickets, send the details to the team. That&rsquo;s the entire planning process. No venue negotiations, no catering arrangements, no entertainment bookings. The experience is built in. The <a href="/first-time-guide" className="gold-link">first-time guide</a> answers common questions and is perfect to share with colleagues who haven&rsquo;t been before.
          </p>
          <p>
        ...
        <section className="scroll-reveal text-center" style={{ marginTop: '2rem' }}>
          <h2>Book Your Team Building Event</h2>
          <p>&pound;55 per person. The team building event your colleagues will actually thank you for.</p>
          <a href="https://www.skiddle.com/whats-on/Warrington/The-Bowdon-Rooms/Rock--Pour/42147525/" target="_blank" rel="noreferrer" className="btn btn-gold btn-large">
            BOOK TEAM EVENT &mdash; &pound;55 PER PERSON
          </a>
        </section>
      </div>
    </main>
