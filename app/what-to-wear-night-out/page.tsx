  ...
  return (
    <main className="section">
      <div className="container">
        ...
        <section className="scroll-reveal" style={{ marginBottom: '3rem' }}>
          <h2>What to Wear: Women</h2>
          <ul style={{ lineHeight: '2', paddingLeft: '1.5rem' }}>
            <li><strong>Dresses &amp; skirts:</strong> Whatever makes you feel great. Midi dresses, mini skirts, jumpsuits &mdash; all work perfectly.</li>
            <li><strong>Tops &amp; bottoms:</strong> A nice top with jeans or trousers is a classic choice. Leather jackets over a pretty top is peak Rock &amp; Pour style.</li>
            <li><strong>Footwear:</strong> This is the most important decision. Choose shoes you can dance in for hours. Block heels, ankle boots, or stylish flats are your best friends. Sky-high stilettos will have you sitting down by 10 PM.</li>
            <li><strong>Avoid:</strong> Anything you&rsquo;d be afraid to get a drink splashed on. The atmosphere is lively and the drinks are unlimited.</li>
          </ul>
        </section>
        ...
        <section className="scroll-reveal" style={{ marginBottom: '3rem' }}>
          ...
          <h3><a href="/corporate-events" className="gold-link">Corporate Events</a></h3>
          <p>
            You can keep it professional or use the night as a chance to show your personality. Smart-casual works perfectly for <a href="/team-building-events" className="gold-link">team building events</a> &mdash; professional enough for colleagues, relaxed enough for a party.
          </p>
        </section>
        ...
        <section className="scroll-reveal text-center" style={{ marginTop: '2rem' }}>
          <h2>Get Dressed Up &amp; Get Your Tickets</h2>
          <p>&pound;55 all-inclusive. You bring the outfit. We bring the band, the drinks, and the atmosphere.</p>
